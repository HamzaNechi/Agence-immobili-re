						...
						<div class="row">
							<div class="col-lg-4">
										...
										<div class="d-flex flex-column align-items-center text-center pt-5">
											<img src="{{URL::asset('assets/images/avatars/user.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
											<div class="mt-3">
												<h4>{{ Auth::user()->name }}</h4>
												<p class="text-secondary mb-1">Fondateur</p>
												<p class="text-muted font-size-sm">Chef d'agence</p>
