(function($) {
	...
	if($('.price-range-slider').length){
		$( ".price-range-slider" ).slider({
			range: true,
			min: parseInt($("#minprix").val()),
			max: parseInt($("#maxprix").val()),
			values: [ parseInt($("#minprix").val()), parseInt($("#maxprix").val()) ],
	...
	if($('.area-range-slider').length){
		$( ".area-range-slider" ).slider({
			range: true,
			min: parseInt($("#minsuper").val()),
			max: parseInt($("#maxsuper").val()),
			values: [ parseInt($("#minsuper").val()), parseInt($("#maxsuper").val()) ],
			slide: function( event, ui ) {
